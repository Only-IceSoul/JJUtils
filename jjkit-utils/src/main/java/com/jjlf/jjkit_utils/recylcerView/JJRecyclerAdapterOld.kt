...
class JJRecyclerAdapterOld<T>(private val items: MutableList<T?> = mutableListOf()) : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    fun setIsFetchMoreEnabled(boolean: Boolean): JJRecyclerAdapterOld<T>{
    ...
    fun setToken(num:Int) : JJRecyclerAdapterOld<T> {
         mToken = num
        return this
    }
    ...
    fun setViewCreator(creator:(Context)->View): JJRecyclerAdapterOld<T> {
         mViewCreator = creator
         return this
    }
    fun setProgressViewCreator(creator:(Context)->View): JJRecyclerAdapterOld<T> {
        mProgressViewCreator = creator
        return this
    }

    fun setOnBindProgressCallback(bind: ()->Unit): JJRecyclerAdapterOld<T> {
        mBindProgressCallback =  bind
        return this
    }
    fun setOnBindErrorCallback(bind: ()->Unit): JJRecyclerAdapterOld<T> {
        mBindErrorCallback =  bind
        return this
    }
    fun setErrorViewCreator(creator:(Context)->View): JJRecyclerAdapterOld<T> {
        mErrorViewCreator = creator
        return this
    }

    fun setOnBindCallback(bind: (item:T?,View,position:Int)->Unit): JJRecyclerAdapterOld<T> {
        mBindCallback = bind
        return this
    }

    fun setFetchMoreCallback(callback: ()->Unit) : JJRecyclerAdapterOld<T> {
